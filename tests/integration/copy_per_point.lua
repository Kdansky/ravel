...
local GAME = [==[{
  ...
  "cards": [
    ...
    { "key": "gated_1", "text": "Doom 1", "tags": ["immutable"],
      "abilities": [{ "key": "gated", "needs": ["doom@mine.player >= 1"], "action": ["options:take,draw:optional"] }] },
    { "key": "gated_2", "text": "Doom 2", "tags": ["immutable"],
      "abilities": [{ "key": "gated", "needs": ["doom@mine.player >= 2"], "action": ["options:take,draw:optional"] }] },
