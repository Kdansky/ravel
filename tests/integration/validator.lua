...
local CASES = {
	...
	{ "a checkered that isn't a pair of colours", "checkered should be two colours",
		function(g) g.style_defs = { tiled = { checkered = { "cream" } } } end },
	{ "a checkered colour that isn't one", "is not a colour",
		function(g) g.style_defs = { tiled = { checkered = { "cream", "octarine" } } } end },
