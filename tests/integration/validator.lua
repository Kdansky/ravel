...
local CASES = {
	...
	{ "an end condition still written as zone_empty", "zone_empty is gone",
	...
	{ "a gate that is neither a condition nor a list of them", "should be a list of conditions",
		function(g) g.card_defs.c_flee.needs = 3 end },
