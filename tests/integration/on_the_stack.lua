...
local GAME = [==[{
  ...
  "cards": [
    ...
    { "key": "echo", "text": "Echo", "tags": ["unit"],
      "reactions": [{ "to": "cast", "from": "board", "key": "again", "text": "Again",
        "action": ["copy:answered"] }] },
    { "key": "jandra", "text": "Jandra", "tags": ["unit"],
      "reactions": [{ "to": "cast", "from": "board", "key": "take_it", "text": "Take it",
        "where": ["not_self@target"], "action": ["redirect:answered:self"] }] },
    { "key": "crook", "text": "Crook", "tags": ["unit"],
      "reactions": [{ "to": "cast", "from": "board", "key": "shove", "text": "Shove",
