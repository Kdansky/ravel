...
def puzzle_cards():
    ...
    return [
        ...
        {"key": "its_a_trap", **shape("its_a_trap", "brown"),
         "play": {"phases": ["action"], "cost": {"acts@mine.player": 1},
                  "action": ["purge:self", "stat_gain:acts@mine.player:1"]}},
        ...
        {"key": "button_mashing", **shape("button_mashing", "brown"),
         "play": {"phases": ["action"], "cost": {"acts@mine.player": 1},
                  "action": ["purge:self", "stat_gain:acts@mine.player:2"]}},
        ...
        {"key": "degenerate_trasher", **shape("degenerate_trasher", "brown"),
         "play": {"phases": ["action"], "cost": {"acts@mine.player": 1},
                  ...
                  "action": ["purge:target", "stat_gain:acts@mine.player:1"],
                  "spent": "mine.table"}},
        ...
        {"key": "dashing_strike", **shape("dashing_strike", "red"),
         "play": {"phases": ["action"], "cost": {"acts@mine.player": 1},
                  "target": {"type": "card", "tags": ["gem_1"], "zones": ["gem_pile"],
                             "owner": "mine", "count": 1},
                  "action": ["stat_gain:act_brown@mine.player:1", "purge:target",
                             "take:bank.gem_1:enemy.gem_pile:1"],
                  "spent": "mine.table"}},
...
def character_chips():
    ...
    return [
        ...
        {"key": "reversal", "text": "Reversal", "tags": ["chip", "character", "purple"],
         ...
         "reactions": [{"to": "crash", "text": "Counter-crash", "needs": ANSWERABLE,
                        ...
                        "action": ["stat_set:crashed@mine.player:sum:value@target",
                                   ...
                                   "purge:mine.gem_1:sum:crashed@opponent",
        ...
        {"key": "no_more_lies", "text": "No More Lies", "tags": ["chip", "character", "red"],
         ...
         "play": {"phases": ["action"], "cost": {"acts@mine.player": 1},
                  "target": upto(hand_chip, 0, 2, tags=["trashable"]),
                  "action": ["purge:target", "stat_gain:act_red@mine.player:1",
                             "move_to:mine.table"]}},
        ...
        {"key": "burst_of_speed", "text": "Burst of Speed", "tags": ["chip", "character", "brown"],
         ...
         "play": {"phases": ["action"], "cost": {"acts@mine.player": 1},
                  "action": ["stat_gain:extra@mine.player:1", "purge:self"]}},
        ...
        {"key": "more_shiny", "text": "More Shiny", "tags": ["chip", "character", "brown"],
         ...
         "play": {"phases": ["action"], "cost": {"acts@mine.player": 1},
                  "target": {"type": "card", "tags": ["gem_1"], "zones": ["hand", "gem_pile"],
                             "owner": "mine", "count": 1},
                  "action": ["purge:target", "stat_gain:money@mine.player:1",
...
def choice_cards():
    ...
    return [
        ...
        choice("js_trash", "Trash a wound and take a red action",
               ["purge:mine.hand:1", "stat_gain:act_red@mine.player:1"]),
