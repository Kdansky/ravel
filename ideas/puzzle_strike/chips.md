# Puzzle Strike — the chips, transcribed

Read off the photographs in this folder, which are the owner's own set, and
cross-checked against `list of all cards.txt` — the owner's own inventory,
which is what settles every name here. Where a photo of a physical chip
disagrees with a printed sheet the photo wins; where a chip is obscured or
absent it is listed under *Missing* rather than guessed at.

`rules.md` is the rulebook; this file is the components.

**Two editions are in play and it matters.** The physical chips photographed
(`most cards scan.jpg`, `more cards.jpg`, the `Screenshot_*.png` set,
`even more cards.webp`, `argarga and fox.webp`) are **third edition**. The
sheet `all base characters v1.webp` is **version 4.7, © 2010** — an earlier
printing, and several chips were reworded after it. Third-edition text is used
wherever a physical chip was photographed; the v1 sheet fills the gaps and every
entry it is the only source for is marked **[2nd ed]**. §*Edition differences*
below lists every place the two disagree.

`Screenshot_20260823_101124.png` photographs a second and third edition chip
side by side and is what dates the costs: One of Each went 6 → **5**, One-Two
Punch 5 → **4**, Iron Defense 5 → **4**. Every cost here is the third-edition
one.

## The symbol vocabulary

Every chip says what it gives in icons rather than words, and four icons cover
almost everything:
...
purple for the crash family), and an **orb** is an ordinary play. So "purple
orb" means a Crash Gem or Combine played on your turn and "purple shield" means
one played as a counter-crash — two different things a chip may forbid, and
Knockdown forbids only the second.

`One of Each` is the proof: cost 5, one of each of the four — an arrow, a buy,
`$1`, and a chip. A banner's colour is also its type: red is an attack, blue a
reaction, purple the crash family, brown/tan plain.

## The bank, always present
...
| 3-gem | 5 | value 3 |
| 4-gem | 7 | value 4 |
| Combine (purple) | 4 | Combine two gems in your gem pile into one, if the total is 4 or less. −$1. +1 action |
| Crash Gem (purple) | 5 | Break one gem in your gem pile and send that many 1-gems to a chosen opponent. +$1 |
| Double Crash Gem (purple) | 9 | As Crash Gem, up to two gems. +$2 |
| Wound | 0 | "This chip does nothing." |

## The base Puzzle chips — 24 designs, five copies each

All twenty-four are in `most cards scan.jpg` rows 3–5, and the names match
`list of all cards.txt` exactly. Ten of the twenty-four go into the bank in any
one game (rules.md §3).
...
| Iron Defense | 4 | brown | Put a Crash Gem from the bank into your gem pile. You may play it later as if from your hand. |
...
Every starting deck is the same ten chips but three: 3 character chips,
1 Crash Gem and 6 1-gems (rules.md §4). Only the three change.

**Argagarg** — defensive disruption

| Chip | Banner | Text |
|---|---|---|
| Hex of Murkwood | red | +1 blue action. Each opponent gains a wound or discards two wounds. |
| Bubble Shield | blue | Ongoing: Negate a gem sent to you, then discard this chip. Reaction: Become immune to a red chip. |
| Protective Ward | brown | +1 blue action. Ongoing: Players can't combine gems unless they discard a Puzzle chip first. Discard this at the end of your next action phase. |
...
| Chip | Banner | Text |
|---|---|---|
| Dragon Form | brown | Ongoing: Each ante phase, ante a gem of 1 higher than usual, or discard this chip. Your purples can't be reacted to. You can't buy purples. |
| Rigorous Training | blue | Reaction: When an opponent buys a 4-cost or more chip, trash a non-purple chip from your hand then gain a chip costing up to 2 more than the trashed chip. |
| Purge Bad Habits | brown | Trash a chip from your hand. Put a 2-gem from the bank into your hand. (Character chips can't be trashed.) |
...
| Chip | Banner | Text |
|---|---|---|
| Living on the Edge | brown | If your gem pile totals at least 10, +3 chips, +1 action. |
| Panda's Bargain | brown | Ongoing: At the end of any turn you bought a Puzzle chip, +1 chip. Discard this when you buy a purple. |
| Jackpot | brown | Reveal two chips at random from chosen opponent's hand. If any are gems, +$1 and +1 action. If both are purples, play and gain a purple from the bank. |

**Grave** — the generalist
...
| Chip | Banner | Text |
|---|---|---|
| Research & Development | brown | +1 action. Exchange a chip in your hand with a purple from your bag. **[2nd ed]** |
| Future Sight | brown | +2 chips. Put two chips from your hand on top of your bag in any order. **[2nd ed]** |
| It's Time for the Past | brown | +1 action. Put a non-Puzzle chip from your discard pile into your hand. |

### Edition differences — v1 (4.7, 2010) against the owner's third edition

Where a chip was photographed, the third-edition text above is what is printed
on it. These are the places the v1 sheet says something else, kept because they
say which way the design moved:

| Chip | v1 | Third edition |
|---|---|---|
| Hex of Murkwood | Each opponent puts a wound chip in his bag, then antes a 1-gem for each wound in his discard pile | Each opponent gains a wound or discards two wounds |
| Protective Ward | Opponents can't play more than one brown-banner chip per turn. Discard at the start of your next turn | Players can't combine gems unless they discard a Puzzle chip first. Discard at the end of your next action phase |
| Dragon Form | Ante 2 instead of 1 each turn. Your purples cannot be counter-crashed. Discard when you buy a purple | Ante a gem of 1 higher than usual *or discard this chip*. Your purples can't be reacted to. You can't buy purples |
...
| Lum's third chip | **Poker Winnings** — a plain 2-gem, no text | **Jackpot** |

## Shadows expansion

`list of all cards.txt` names ten more characters — **Quince, Onimaru, BBB,
Troq, Menelker, Persephone, Gloria, Gwen, Vendetta, Zane** — and twenty-four
more Puzzle chips.

### Shadows Puzzle chips

Twenty-two of the twenty-four are on the printed reference sheet in
`more character chips.jpg`; **The Hammer** is not, and neither is the base
game's Master Puzzler — the two 12-cost chips are both left off it, and both
turn up instead in the tray photo `more character chips.jpg`.
...
| Chips for Free | 4 | brown | +2 chips. Trash a chip from your hand. If you do, gain a chip costing up to 2 more than the trashed chip. |
| Color Panic | 3 | red | +1 red action. Choose blue, red, purple or brown. Each opponent discards a chip of that banner colour, or reveals his hand if he can't. If any can't, +1 action. |
| Degenerate Trasher | 8 | brown | +1 action. Trash up to two chips from your hand. (Character chips can't be trashed.) |
| Ebb or Flow | 2 | blue | Main or Reaction: Choose one: all players trash a 1-gem from their gem piles — OR — you ante a 2-gem. |
| Hundred-Fist Frenzy | 4 | brown | Ongoing: After you red-attack, you may crash a gem in your gem pile. Discard if an opponent skips his action phase. |
| Improvisation | 4 | blue | Main: +2 chips. Discard 2 drawn and play the other drawn chips. Reaction: After you're red-attacked, you may play a chip as if it were your turn. |
...
### Shadows character chips — all thirty

`Screenshot_20260823_110841.png` is the whole set in one shot, five rows of six,
grouped in threes by character; the two close-ups beside it
...
of each character chip, and the bank counts in rules.md §3.

## Two rules the change document settles

**Panic Time is a ratchet.** X is the number of players; X empty bank stacks
antes 2-gems, X+1 antes 3-gems, X+2 antes 4-gems — and *"empty stacks refilling
does not revert the ante."* Nothing in the built game refills a stack, so
counting empties is the same number either way there; a game that adds Into
Oblivion would need the high-water mark kept rather than recomputed.

**Three and four players** is a bigger change than the player count: you may
crash to anyone, everybody gets a chance to react in turn order starting with
the target, other people's crashes give you no money, the moment somebody is
eliminated the *lowest* pile wins outright, and gems sent to a player already at
ten or more **float** until their pile drops to nine or is destroyed at end of
turn. rules.md §6 has the same rules from the rulebook.
