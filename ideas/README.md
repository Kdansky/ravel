...
|---|---|---|---|
| 77 | [41](41-a-name-for-a-list-of-actions.md) — **the games onto verb bodies** | small each, generator for four of them | the word shipped; the 319 `activate_zone:` call sites and the copied runs (chosen ×20, enters play ×17, sideline ×7, drink ×7) have not moved. Each migration is a byte count and a check that nothing plays differently. Gated routines stay in rules zones until a body can branch |
