...
| [13](13-one-name-one-thing.md) | One name, one thing | small check, one redesign first | not started — every declared name unique. Ownership moves to a field, and chess's 32 self-tags then delete themselves |
