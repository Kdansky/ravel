...
| [44](44-ghost-stories.md) | Ghost Stories | **built and playing**, four seats at Initiation level, all 65 cards. Village and boards are one 5x5 grid, so reach and movement are two patterns and no arithmetic; a Taoist rides its tile. The four seats sit round the village, one to a side. Left: the two-ghost exorcism, tokens lent across a tile, the eight Taoist powers, and neutral boards for fewer than four players |
