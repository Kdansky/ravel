...
| [41](41-a-name-for-a-list-of-actions.md) | A name for a list of actions | **open, and the largest duplication in the box.** 80 invisible cards across three games are a zone standing in for a subroutine, spelled three different ways. The 29 Spellstorm keys no phase calls are the case; the 18 a phase calls are a moment and a different question |
