...
| [43](43-what-the-files-already-say-twice.md) | What the files already say twice | **content work, no engine change.** A tag carrying 63 identical `play` blocks, a stat `start` for 46 `card_stats`, 19 redundant `subject` lines. Verified behaviour-preserving on Spellstorm |
