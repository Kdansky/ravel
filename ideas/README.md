...
| 75 | [40](40-reconnecting.md) — **a dropped game, tried in two browsers** | small | rejoining is built and tested over loopback: the survivor invites again, and the other side sits back in its own seat. Left: watch the panel notice a real WebRTC drop, and decide whether a crashed tab should keep a copy of the game to host from |
