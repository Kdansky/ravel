...
| [20](20-puzzle-strike.md) | Puzzle Strike | **built and playing**, the whole box drafted. Left: a short list of engine features, the buy count and Signature Move's second half, six gems that still break into the void rather than the bank, and the per-chip state is in the game file |
